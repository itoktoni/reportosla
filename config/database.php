    ...
    */
    ...
    'connections' => [
        ...
        'mysql' => [
            ...
            'engine' => null,
            'dump' => [
                'add_extra_option' => 'SQL SECURITY DEFINER',
            ],
        ...
        'backup' => [
            ...
            'engine' => null,
            'dump' => [
                'dump_binary_path' => env('DB_DUMP', 'C:\Program Files\MySQL\MySQL Server 8.4\bin'), // only the path, so without `mysqldump` or `pg_dump`
